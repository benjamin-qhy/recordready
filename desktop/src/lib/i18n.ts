...
const zh = {
  ...
  idle:'准备设备',preparing:'正在准备',ready:'准备就绪',countdown:'倒计时',starting:'正在启动',recording:'录制中',saving:'正在保存',saved:'已保存',partial:'部分文件已保存',failed:'保存失败',
  ...
  font:'字号',speed:'速度',slow:'慢',normal:'适中',fast:'快',promptStart:'开始提词',promptPause:'暂停提词',reset:'回到开头',scriptTitle:'稿件标题',body:'正文',done:'完成编辑',chars:'{{count}} 字',
  ...
  session_busy:'录制会话尚未结束，请先停止并等待保存完成。',not_ready:'请先授权并预览设备。',device_missing:'找不到所需设备，请连接后重试。',device_unavailable:'设备不可用，请检查是否被其他应用占用。',directory_unwritable:'目录不可写，请选择其他目录。',
...
const en: Record<keyof typeof zh,string> = {
  ...
  idle:'Prepare devices',preparing:'Preparing',ready:'Ready',countdown:'Countdown',starting:'Starting',recording:'Recording',saving:'Saving',saved:'Saved',partial:'Some files saved',failed:'Save failed',
  ...
  font:'Font size',speed:'Speed',slow:'Slow',normal:'Normal',fast:'Fast',promptStart:'Start prompter',promptPause:'Pause prompter',reset:'Back to start',scriptTitle:'Script title',body:'Script',done:'Done',chars:'{{count}} characters',
